---
title: "Does a Reverse Mortgage Become Due If You Move to a Nursing Home?"
date: 2026-08-03T06:34:08+08:00
draft: false
tags: ["finance", "reverse-mortgage", "retirement", "eldercare"]
summary: "A reverse mortgage can blow up in your face when a nursing home enters the picture. Here is exactly how the clock starts ticking."
---

Saw this question pop up on r/personalfinance the other day. It’s the exact scenario that keeps estate planners up at night, and frankly, it’s where a reverse mortgage goes from being a useful retirement tool to a ticking time bomb. 
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "Does a reverse mortgage have to be paid back if the owner moves to a nursing home?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes. If the last remaining borrower on the reverse mortgage leaves the home for a nursing facility, HUD generally gives a 12-month grace period before the loan becomes due and payable. If the borrower does not return within 12 months, the loan must be repaid, usually through the sale of the home."
      }
    },
    {
      "@type": "Question",
      "name": "Can a non-borrowing spouse stay in the home if the borrower moves to a nursing home?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "For reverse mortgages originated after August 4, 2014, a non-borrowing spouse can defer repayment and remain in the home as long as they meet HUD's strict requirements, which include paying property taxes and insurance. For older loans, the spouse may be forced to repay the loan or leave the home."
      }
    },
    {
      "@type": "Question",
      "name": "What happens to a reverse mortgage if the borrower dies while in a nursing home?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "The reverse mortgage becomes due and payable upon the borrower's death. The estate or heirs have a short window, typically up to six months, to decide whether to repay the loan, refinance, or sell the home to settle the debt with the lender."
      }
    }
  ]
}
