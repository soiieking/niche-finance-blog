...
- linux
- technology
summary: Inspired by a viral r/selfhosted post about tracking toilet habits, learn
  how to build your own private health dashboard using Docker, Grafana, and custom
  API endpoints.
---
