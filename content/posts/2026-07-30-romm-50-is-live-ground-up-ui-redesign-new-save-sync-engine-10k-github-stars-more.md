...
summary: "RomM 5.0 is here with a ground-up UI redesign and a new save sync engine. Learn how to deploy it on Linux and see what r/selfhosted thinks of the update."
---
